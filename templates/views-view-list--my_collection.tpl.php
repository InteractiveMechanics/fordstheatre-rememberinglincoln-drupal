<?php
	...
	$email_link = "mailto:?subject=" . htmlentities("View My Collection on Remembering Lincoln") . "&body=" . htmlentities("Check out the custom collection I created through Remembering Lincoln, a project of Ford's Theatre:  ") . urlencode(lincoln_current_url());
